 ...
 */
/**
 * Gets constant time from Moose epoch.
...
/**
 * Calculates time since Moose epoch.
 * @param {number|undefined} time - Time in unix seconds.
 * @returns {number} current time - Moose epoch time.
 */
...
module.exports = {
   ...
   * @method
   * @param {number} time
   * @return {number} Moose epoch time constant.
   */
   ...
   * @return {number} constant time from Moose epoch + input time.
   */
